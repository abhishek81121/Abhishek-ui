...
export const Passwordicon=(props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>)=>{
    ...
    role="presentation"
    viewBox="0 0 24 24"
    width="1em" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path opacity="0.5" d="M3.17157 5.17157C2 6.34315 2 8.22876 2 12C2 15.7712 2 17.6569 3.17157 18.8284C4.34315 20 6.22876 20 10 20H14C17.7712 20 19.6569 20 20.8284 18.8284C22 17.6569 22 15.7712 22 12C22 8.22876 22 6.34315 20.8284 5.17157C19.6569 4 17.7712 4 14 4H10C6.22876 4 4.34315 4 3.17157 5.17157Z" fill="currentColor"/>
